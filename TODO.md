...
- [x] Split `AGENTS.md` into a document explaining the design of the project,
      and another document explaining tools, platform and development process.
      Refer to both new files from `AGENTS.md`.
...
- [ ] Pseudo-danish Station names are generated by
      `src/station/create-station-name.ts` and use by Area to name new stations.
- [x] Remove ability to delete stations
- [ ] There is no cost to create stations.
- [ ] Location of Station should be integer numbers.
