...
- [x] Add degradation increment when train moves on track
  - Suggestion: In train movement logic, track.degraded += wear rate (e.g., 0.1
    per pass)
- [x] Implement repair triggering based on degradation
  - Suggestion: In track agent, check if track.degraded > threshold, trigger
    repair
- [x] Add degradation visualization
